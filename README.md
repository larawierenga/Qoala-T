...
This package contains data and R code as described in Klapwijk et al., (in prep). The protocol of our in house developped manual QC procedure can be found [here](https://github.com/larawierenga/Qoala-T/blob/master/Qoala-T_Manual_QC.pdf).  
